...
export default class SignUpPageDataResolver {
    ...
    resolveRegistrationData() {
         ...
         * so we resolve specified data by taking these inputs values -
         * for each of these inputs
         * we find <pre> DOM </pre< element of the page, having special <pre> id </pre>
         * by query selector like <pre> $('#someId') </pre>, then,
         * take a value of element we just found. */
